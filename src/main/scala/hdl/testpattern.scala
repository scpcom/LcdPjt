...
class testpattern(vp: VideoParams) extends RawModule {
 ...
 //====================================================
  ...
  val tp_sync = Module(new VGASync(vp))
  ...
  val De_hcnt = tp_sync.io.hpos //Mux(tp_sync.io.hpos > De_delay, tp_sync.io.hpos-De_delay, 0.U(1.W))
  val De_vcnt = tp_sync.io.vpos //Mux(tp_sync.io.vpos > De_delay, tp_sync.io.vpos-De_delay, 0.U(1.W))
